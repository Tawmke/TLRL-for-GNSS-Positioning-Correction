...
from sb3_161.common.policies import BasePolicy
...
from model.model_torch import RecurrentActorCriticPolicy
from sb3_contrib.common.recurrent.type_aliases import RNNStates
from sb3_contrib.ppo_recurrent.policies import CnnLstmPolicy, MultiInputLstmPolicy#, MlpLstmPolicy
from model.policies_rename import MlpLstmPolicy
...
class RecurrentPPO_custom(OnPolicyAlgorithm):
    ...
    policy_aliases: Dict[str, Type[BasePolicy]] = {
        "MlpLstmPolicy": MlpLstmPolicy,#MlpLstmPolicy,
    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
            ...
            # recording rewards per step
            self.logger.record("rewards per step", rewards)
    ...
    def train(self) -> None:
        ...
        self.logger.record('train/rewards', 1)
        self.logger.record('train/values', values)
        self.logger.record('train/values_pred', values_pred)
