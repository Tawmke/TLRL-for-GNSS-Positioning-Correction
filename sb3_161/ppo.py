...
from sb3_161.common.on_policy_algorithm import OnPolicyAlgorithm
# from stable_baselines3.common.policies import ActorCriticCnnPolicy, ActorCriticPolicy, BasePolicy, MultiInputActorCriticPolicy
from sb3_161.common.policies import ActorCriticCnnPolicy, ActorCriticPolicy, BasePolicy, MultiInputActorCriticPolicy
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                self.logger.record('values/perepoch_values', th.mean(values).item())
                self.logger.record('values/perepoch_values_pred', np.float(th.mean(values_pred)))
        ...
        self.logger.record('values/values_pred', np.float(th.mean(values_pred)))
        self.logger.record('values/returns', th.mean(rollout_data.returns).item())
